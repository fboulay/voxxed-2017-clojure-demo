...
The `home-routes` handler in the `voxxed-2017-clojure.routes.home` namespace
...
The `home-page` function will in turn call the `voxxed-2017-clojure.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/voxxed_2017_clojure/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `voxxed-2017-clojure.handler` namespace:
...
Request middleware functions are located under the `voxxed-2017-clojure.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `voxxed-2017-clojure.dev-middleware` namespace found in
